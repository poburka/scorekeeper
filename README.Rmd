...
**operation**: the operation to preform ('select', 'filter_at', 'recode', 'sum', 'if_else', 'case_when') 
...
**if_else** : creates a new variable based on if_else conventions using 
scoresheet$if_condition 
scoresheet$if_true return
